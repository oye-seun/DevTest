...
namespace UnityStandardAssets.Characters.ThirdPerson
{
	...
	public class ThirdPersonCharacterModified : MonoBehaviour
	{
		...
		public IEnumerator GoDir(Transform target, Action del)
		{
			float dist = 10;
		...
		public IEnumerator AlignPlayer(Vector3 dir, float time, Action del)
		{
			while(time > 0)
			{
				dir = dir.normalized;
