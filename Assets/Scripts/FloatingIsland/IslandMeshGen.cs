...
public class IslandMeshGen : MonoBehaviour
{
    ...
    private void OnDrawGizmos()
    {
        ...
        for (int i = 0;DisplayUVs && i < triangles.Count /*triangleCount*/; i += 3)
        {
        ...
        for (int i = 0; DisplayTriangles && i < triangles.Count; i += 3)
        {
        ...
        for (int i = 0; DisplayVerts && i < islandBoundary.Count; i++)
        {
